...
macro(setops_combine_archives target dependency)
    if(MSVC)
...
macro(setops_fetch_thirdparty_content content_file)
    set(SETOPS_FETCHCONTENT_BASE_DIR_OLD ${FETCHCONTENT_BASE_DIR})
    set(FETCHCONTENT_BASE_DIR ${SETOPS_THIRDPARTY_DIR} CACHE STRING "" FORCE)
    include(${content_file})
    set(FETCHCONTENT_BASE_DIR ${SETOPS_FETCHCONTENT_BASE_DIR_OLD} CACHE STRING "" FORCE)
    unset(SETOPS_FETCHCONTENT_BASE_DIR_OLD)
endmacro()
